...
public class LetterReportServiceTest {
    ...
    public void testGetLetterBatchReport() {
        ...
        assertEquals(letterBatchReport.getFetchTarget(), "oppilaitos");
    ...
    public void testGetLetterBatchesBySearchArgument() {
        ...
        assertTrue(letterBatchesReport.getLetterBatchReports().get(0).getFetchTarget().equalsIgnoreCase("oppilaitos"));
    }
