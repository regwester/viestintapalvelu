...
public class AnswerChain<T> implements Answer<T> {
    ...
    protected static class DoNothing<T> implements Answer<T> {
        @Override
    ...
    public static AnswerChain<Void> atFirstDoNothing() {
        return atFirst(new DoNothing<Void>());
    }
