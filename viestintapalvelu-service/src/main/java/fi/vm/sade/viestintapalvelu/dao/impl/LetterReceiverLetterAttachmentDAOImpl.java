 ...
 */
@Repository
public class LetterReceiverLetterAttachmentDAOImpl extends AbstractJpaDAOImpl<LetterReceiverLetterAttachment, Long>
            implements LetterReceiverLetterAttachmentDAO {
}
