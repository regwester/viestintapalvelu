...
public class LetterBuilder {
	...
	if (template != null) {
	    ...
	    for (TemplateContent tc : contents) {
		byte[] page = createPageXhtml(template, tc.getContent().getBytes(),
     ...
     */
    private byte[] createPageXhtml(Template template, byte[] pageContent, Map<String, Object> templateReplacements) 
