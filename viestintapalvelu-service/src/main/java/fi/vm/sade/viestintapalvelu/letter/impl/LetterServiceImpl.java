...
public class LetterServiceImpl implements LetterService {
    ...
    /* ---------------------- */
	/* (non-Javadoc)
     * @see fi.vm.sade.viestintapalvelu.letter.LetterService#createLetter(fi.vm.sade.viestintapalvelu.letter.LetterBatch)
     */
	@Override
    ...
    /* ------------ */
    /* (non-Javadoc)
     * @see fi.vm.sade.viestintapalvelu.letter.LetterService#findById(long)
     */
    @Override
...
//		Not implemented
    ...
    /* ------------------------------- */
	/* (non-Javadoc)
     * @see fi.vm.sade.viestintapalvelu.letter.LetterService#findLetterBatchByNameOrgTag(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     */
	@Override
    ...
    /* ------------------------------- */
	/* (non-Javadoc)
     * @see fi.vm.sade.viestintapalvelu.letter.LetterService#findReplacementByNameOrgTag(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     */
	@Override
...
//TODO: tähän tietyt kentät Mandatory true esim. title body ...			
    ...
    /* ------------- */
	/* (non-Javadoc)
     * @see fi.vm.sade.viestintapalvelu.letter.LetterService#getLetter(long)
     */
	@Override
