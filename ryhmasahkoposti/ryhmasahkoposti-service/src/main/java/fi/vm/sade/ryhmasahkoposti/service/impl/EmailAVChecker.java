...
public class EmailAVChecker {
	...
	private static final Logger log = Logger
			.getLogger(fi.vm.sade.ryhmasahkoposti.service.impl.EmailAVChecker.class
					.getName());
	...
	/*
	 * Checks MimeMessage for Viruses
	 * Does not find viruses in attachments. Check attachments separately.
	 * @param sender
	 * @param message
	 * @return
	 * @throws IOException
	...
	private boolean isInfected(MimeMessage message) throws IOException,
			MessagingException {
	...
	private String getAVResponse(String command, InputStream data)
			throws IOException {
