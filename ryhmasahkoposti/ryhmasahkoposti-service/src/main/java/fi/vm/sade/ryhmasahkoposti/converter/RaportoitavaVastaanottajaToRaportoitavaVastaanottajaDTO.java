...
public class RaportoitavaVastaanottajaToRaportoitavaVastaanottajaDTO {
	...
	public static EmailRecipientDTO convertToEmailRecipientDTO(
			RaportoitavaVastaanottaja vastaanottaja) {
		...
		emailRecipientDTO.setEmailMessageID(vastaanottaja
				.getRaportoitavaviesti().getId());
		return emailRecipientDTO;
	}

	public static RaportoitavaVastaanottajaDTO convert(
			RaportoitavaVastaanottaja vastaanottaja) {
		...
		vastaanottajaDTO.setVastaanottajanOid(vastaanottaja
				.getVastaanottajaOid());
		vastaanottajaDTO.setVastaanottajanSahkopostiosoite(vastaanottaja
				.getVastaanottajanSahkoposti());
		vastaanottajaDTO.setViestiID(vastaanottaja.getRaportoitavaviesti()
				.getId());
