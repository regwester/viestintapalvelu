...
public class GroupEmailReportingServiceTest {
	...
	groupEmailReportingService = new GroupEmailReportingServiceImpl(mockedReportedMessageService, 
		...
		mockedCurrentUserComponent, mockedOrganizationComponent, mockedTemplateComponent, 
		mokedReportedMessageReplacementConverter, mockReportedMessageReplacementService, 
	...
	when(mockedReportedMessageConverter.convert(any(EmailMessage.class), eq("null"))).thenReturn(new ReportedMessage());
	...
	when(mockedEmailMessageDTOConverter.convert(any(ReportedMessage.class), any(List.class), any(List.class))).thenReturn(
