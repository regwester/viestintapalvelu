...
.controller('EmailSendStatusCtrl', ['$scope', '$rootScope', 'EmailSendStatusFactory', '$state', '$timeout', 'ErrorDialog',
  function($scope, $rootScope, EmailSendStatusFactory, $state, $timeout, ErrorDialog) {
